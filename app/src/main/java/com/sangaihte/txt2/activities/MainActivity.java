...
import com.sangaihte.txt2.adapters.RecentConversationsAdapter;
import com.sangaihte.txt2.databinding.ActivityMainBinding;
...
public class MainActivity extends BaseActivity implements ConversationListener {
    ...
    private void updateToken(String token) {
        ...
        documentReference.update(Constants.KEY_FCM_TOKEN, token)
                .addOnFailureListener(e -> showToast("Unable to upload token"));
    }
